...
type Documents = {
    ...
    "query PageArchiveArticles($page: Int!, $pageSize: Int!, $pageName: String, $positionKey: String) {\n  pageArchiveArticles(\n    page: $page\n    pageSize: $pageSize\n    pageName: $pageName\n    positionKey: $positionKey\n  ) {\n    items {\n      id\n      slug\n      title\n      body\n      status\n      authorName\n      thumbnailUrl\n      videoUrl\n      createdAt\n      publishedAt\n    }\n    total\n    page\n    pageSize\n    hasMore\n  }\n}": typeof types.PageArchiveArticlesDocument,
};
const documents: Documents = {
    ...
    "query PageArchiveArticles($page: Int!, $pageSize: Int!, $pageName: String, $positionKey: String) {\n  pageArchiveArticles(\n    page: $page\n    pageSize: $pageSize\n    pageName: $pageName\n    positionKey: $positionKey\n  ) {\n    items {\n      id\n      slug\n      title\n      body\n      status\n      authorName\n      thumbnailUrl\n      videoUrl\n      createdAt\n      publishedAt\n    }\n    total\n    page\n    pageSize\n    hasMore\n  }\n}": types.PageArchiveArticlesDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PageArchiveArticles($page: Int!, $pageSize: Int!, $pageName: String, $positionKey: String) {\n  pageArchiveArticles(\n    page: $page\n    pageSize: $pageSize\n    pageName: $pageName\n    positionKey: $positionKey\n  ) {\n    items {\n      id\n      slug\n      title\n      body\n      status\n      authorName\n      thumbnailUrl\n      videoUrl\n      createdAt\n      publishedAt\n    }\n    total\n    page\n    pageSize\n    hasMore\n  }\n}"): (typeof documents)["query PageArchiveArticles($page: Int!, $pageSize: Int!, $pageName: String, $positionKey: String) {\n  pageArchiveArticles(\n    page: $page\n    pageSize: $pageSize\n    pageName: $pageName\n    positionKey: $positionKey\n  ) {\n    items {\n      id\n      slug\n      title\n      body\n      status\n      authorName\n      thumbnailUrl\n      videoUrl\n      createdAt\n      publishedAt\n    }\n    total\n    page\n    pageSize\n    hasMore\n  }\n}"];
