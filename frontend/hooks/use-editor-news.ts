...
export function useEditorNews(): IEditorNews {
  ...
  return {
    ...
    worldwide: detailEditor.worldwide,
    setWorldwide: detailEditor.setWorldwide,
    excludedMarketIds: detailEditor.excludedMarketIds,
    setExcludedMarketIds: detailEditor.setExcludedMarketIds,
    handleWorldwidePlacementResult: detailEditor.handleWorldwidePlacementResult,
    handleWorldwidePlacementError: detailEditor.handleWorldwidePlacementError,
