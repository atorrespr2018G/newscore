"""Raise homepage compact carousel slot limits from 6 to 12.

Matches World Asia/Oceania bands so Politics, Sports, Health (finance),
Entertainment, Technology, and Business can paginate with left/right arrows
across market and region-owned homepage layouts (country/state/county/town).
"""
...
async def run() -> dict[str, Any]:
    """Update query_rule.limit for homepage compact carousel slots."""
