"""Raise homepage Style and Travel compact carousel limits from 4 to 12.

Matches Business and Technology so those homepage bands can paginate with
left/right arrows across market and region-owned homepage layouts.
"""
...
COMPACT_BAND_POSITION_KEYS = ("style", "travel")
...
async def run() -> dict[str, Any]:
    """Update query_rule.limit for homepage Style and Travel slots."""
