"""MongoDB business page section list document model."""
...
class BusinessPageSectionItem(BaseModel):
    """One ordered section on a business page (hero, band, live, topic, or ad)."""
...
class BusinessPageSections(BaseModel):
    """Ordered business page sections for a market or a state region.
    ...
    items: list[BusinessPageSectionItem] = []
